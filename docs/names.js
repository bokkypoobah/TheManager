      ...
      <b-card no-body no-header class="border-0">
        ...
        <div class="d-flex flex-wrap m-0 p-0">
          <div class="mt-0 pr-1" style="width: 200px;">
            <b-form-input type="text" size="sm" v-model.trim="settings.filter" @change="saveSettings" debounce="600" v-b-popover.hover.top="'Regex filter by name, without the .eth postfix'" placeholder="🔍 name regex"></b-form-input>
          </div>
          <div class="mt-0 pr-1">
